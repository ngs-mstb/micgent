...
class GFF3Test(unittest.TestCase):
    ...
    def t_gff_annotations(self):
        ...
        final_rec = rec_dict['I']
        assert len(list(final_rec.annotations.keys())) == 2
    ...
    def t_novalue_key(self):
        ...
        assert "ID" not in f1.sub_features[0].qualifiers
...
class GFF2Tester(unittest.TestCase):
    ...
    def t_wb_cds_nested_features(self):
        ...
        features = list(rec_dict.values())[1].features
...
class OutputTest(unittest.TestCase):
    ...
    def t_gff3_to_gff3(self):
        ...
        GFF.write(list(recs.values()), out_handle)
        wrote_handle = io.StringIO(out_handle.getvalue())
